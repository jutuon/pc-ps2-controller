...
const CONTROLLER_RAM_SIZE: usize = (RawCommands::READ_RAM_END - RawCommands::READ_RAM_START + 1) as usize;

pub struct RawCommands;

impl RawCommands {
    const READ_CONTROLLER_COMMAND_BYTE: u8 = 0x20;
    const READ_RAM_START: u8 = 0x21;
    const READ_RAM_END: u8 = 0x3F;

    const WRITE_CONTROLLER_COMMAND_BYTE: u8 = 0x60;
    const WRITE_RAM_START: u8 = 0x61;
    //const WRITE_RAM_END: u8 = 0x7F;

    //const TEST_PASSWORD_INSTALLED: u8 = 0xA4;
    //const LOAD_PASSWORD: u8 = 0xA5;
    //const ENABLE_PASSWORD: u8 = 0xA6;
    const DISABLE_AUXILIARY_DEVICE_INTERFACE: u8 = 0xA7;
    const ENABLE_AUXILIARY_DEVICE_INTERFACE: u8 = 0xA8;
    const AUXILIARY_DEVICE_INTERFACE_TEST: u8 = 0xA9;
    const SELF_TEST: u8 = 0xAA;
    const KEYBOARD_INTERFACE_TEST: u8 = 0xAB;
    const DISABLE_KEYBOARD_INTERFACE: u8 = 0xAD;
    const ENABLE_KEYBOARD_INTERFACE: u8 = 0xAE;
    ...
    const WRITE_TO_AUXILIARY_DEVICE: u8 = 0xD4;
